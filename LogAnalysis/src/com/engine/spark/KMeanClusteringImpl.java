...
public class KMeanClusteringImpl {
	...
	static JavaPairRDD<String, Vector> getFeatureizedData(String featurizedData,
	...
	static List<Vector> getInitialCentroids(JavaPairRDD<String, Vector> data,
			final int K) {
	...
	static double getDistance(final List<Vector> centroids,
	...
	public static void main(String[] args) throws Exception {
		...
		final String featurizedData = "/home/roshan/SparkPractises/featurized";
		//
		...
		for (int i = 0; i < centroids.size(); i++) {
			...
			.println("/***************************************************************  cluster "
					...
					+ "*************************************************/");
			final int index = i;
			List<Tuple2<String, Vector>> samples = data.filter(
					new Function<Tuple2<String, Vector>, Boolean>() {
